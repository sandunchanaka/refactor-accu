...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td bgcolor="#F1F3F5" class="adminlist"><strong>Edit News Details</strong></td>
        </tr>
        <tr>
          <td bgcolor="#F1F3F5"><form action="controlers/newscontroler.php?mode=edit_news" method="post" enctype="multipart/form-data" name="form1" id="form1">
            <table width="80%"  border="0" align="center" cellpadding="2" cellspacing="2" class="cls_border">
              ...
              <tr>
                <td width="4%">&nbsp;</td>
                <td colspan="3"><div id="error"><?php include(ADMIN_MESSAGES.'News.message.php'); ?>
...
?></td>
              ...
              <tr>
                ...
                <td><div align="right">
                  ...
                  <input name="btn_cancel" type="button" class="button" value="   Skip   " onclick="window.location.href='news_attechments.php?news_id=<?php echo $_REQUEST['news_id']; ?>'" id="btn_cancel" />
                </div></td>
              </tr>
            </table>
          </form></td>
