        ...
        <tr>
          <td bgcolor="#F1F3F5"><form action="controlers/newscontroler.php?mode=uploadsnews" method="post" enctype="multipart/form-data" name="form1" id="form1">
            <table width="79%"  border="0" align="center" cellpadding="2" cellspacing="2">
              ...
              <tr>
                <td colspan="5"><div id="error"><?php include(ADMIN_MESSAGES.'News.message.php'); ?>
                </div></td>
                </tr>
              <tr>
                <td>&nbsp;</td>
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <?php $newsfiles = News :: passnewsDocuments($_REQUEST['news_id'],'NRN');
					...
					?>
                  <tr>
                    <td width="16%"><div align="right">&nbsp;&nbsp;<a onclick="deleteFilesNewsAtt2('<?php echo $row1['value']['file_id'];?>');" href="#"><img src="../images/delete.png" width="16" height="16" /></a></div></td>
                    <td width="2%">&nbsp;</td>
