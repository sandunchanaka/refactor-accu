...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td bgcolor="#F1F3F5" class="adminlist"><strong>New Credit Union Solution</strong></td>
        </tr>
        <tr>
          <td bgcolor="#F1F3F5"><form action="controlers/CUSolutioncontroler.php?mode=uploads" method="post" enctype="multipart/form-data" name="form1" id="form1">
            <table width="79%"  border="0" align="center" cellpadding="2" cellspacing="2">
              ...
              <tr>
                <td colspan="5"><div id="error"><?php include(ADMIN_MESSAGES.'CUSolution.message.php'); ?>
                </div></td>
                </tr>
              <tr>
                <td>&nbsp;</td>
              ...
              <tr>
                ...
                <td>&nbsp;</td>
                <td>&nbsp;</td>
                <td width="52%"><input name="btn_add" type="submit" class="button" value="   Add   " id="btn_add" /> <input name="Submit2" type="button" class="button" value="   Finish   " onclick="window.location.href='Credit_Union_Solution.php'" /></td>
                <td width="19%">&nbsp;</td>
              </tr>
            </table>
          </form></td>
