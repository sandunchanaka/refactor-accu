        ...
        <tr>
          <td bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" enctype="multipart/form-data" action="controlers/publication_type_controler.php?mode=edit_pub_type">
            <table width="80%"  border="0" align="center" cellpadding="2" cellspacing="2" class="cls_border">
              ...
              <tr>
                <td colspan="4"><div id="error"><?php include(ADMIN_MESSAGES.'publication_type.message.php'); ?>
                    <span class="color_button">
                    <input type="hidden" name="hdn_pub_type_id" id="hdn_pub_type_id" value="<?php echo $pub_type['publication_cat_id'];?>" />
                    </span></div></td>
                </tr>
              ...
              <tr>
                <td colspan="4" valign="top"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">                  
                  <tr>
                    ...
                    <td colspan="2"><input name="public_cat_type" type="text" class="login_text" id="public_cat_type"  value="<?php echo $pub_type['pub_cat_name'];?>"/></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td width="74" valign="top"><div align="center">
                        <img src="../upload_images/Publication/thumb/<?php echo $pub_type['pub_cat_image'];?>" />
              ...
              <tr>
                ...
                <td width="58%"><input name="btn_add" type="submit" class="button" value="     Edit      " id="btn_add" />
                  <input name="btn_cancel" type="button" class="button" value="   Cancel   " onclick="window.location.href='publication_type.php'" id="btn_cancel" /></td>
              </tr>
            </table>
          </form></td>
        </tr>
