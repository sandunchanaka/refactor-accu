	...
	switch($mode)
	{
					  ...
					  if(is_dir(FILEREPOSITORY.$type)) /// IF for check repository exist
						{
							...
							if($u_usedoc!="")
							{
								$insert_doc	=about_us_Document::insert_doc($cate_id,$txt_doc_title,$u_usedoc,$add_date,$update,$cmb_doctype);
								if($insert_doc==true)/////////////***/*/***//////////
								{					
									...
									for($a=1;$a<=count($user_level);$a++)
									{
										...
										$result=about_us_Document::insert_doc_display($doc_id,$user_level_id,$txt_doc_title,$cate_id,$u_usedoc,$display,$cmb_doctype);
		...
		////////////////////////////////////////////////////////////////////////////////////////						
								...
								if($u_upfile!="")
								{
									...
									$insert_doc	= about_us_Document :: insert_doc($cate_id,$txt_doc_title,$u_upfile,$add_date,$update,$cmb_doctype);
									...
									{					
										...
										for($a=1;$a<=count($user_level);$a++)
										{
											...
											$display=isset($_POST[$chkname])?1:0;
												...
												$result=about_us_Document::insert_doc_display($doc_id,$user_level_id,$txt_doc_title,$cate_id,$u_upfile,$display,$cmb_doctype);
