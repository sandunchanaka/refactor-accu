...
switch($msg)
{
	...
	case '14':
		$display_msg ="Successfull insert member contact details";
	break;	
	...
	case '17_a':
		$display_msg ="Select Borde Of Derector catagory number";
	break;
	
	case '18':
		$display_msg ="Enter Borde Of Derector catagory name";
	break;
	
	case '19':
		$display_msg ="Successfull Add staff member";
	break;
	...
	case '22':
	$display_msg = "Successfull update member details";
	break;
	...
	case '24':
	$display_msg = "Successfull update staff member details";
	break;
	...
	case '38':
	$display_msg = "Delete Contact Person details";
	break;
	...
	case '40':
	$display_msg = "Successfuly Update Contact Person details";
	break;
