...
switch($msg)
{
	...
	case '1':
	$display_msg = "Please enter a category information";
	break;
	...
	case '3':
	$display_msg = "Re-enter category ......";
	break;
		
	case '4':
	$display_msg = "Category already exists";
	break;

	case '5':
	$display_msg = "New category created";
	break;

	case '6':
	$display_msg = "Error creating new category";
	break;		
