...
class about_us_Document 
{
	...
	function insert_doc($cate_id,$txt_doc_title,$up_doc,$add_date,$update,$m_doc_type)
	{
		//echo "wwwwww"; exit;
			$sqlInsert="INSERT INTO user_doc VALUES(NULL,'".$cate_id."','".$txt_doc_title."','".$up_doc."','".$add_date."','".$update."','".$m_doc_type."')";
			//echo $sqlInsert; exit;
	...
	function insert_doc_display($doc_id,$user_level_id,$txt_doc_title,$cate_id,$up_doc_name,$display,$m_doc_type)
	{
		$sqlInsert="INSERT INTO user_doc_display VALUES('".$doc_id."','".$user_level_id."','".$txt_doc_title."','".$cate_id."','".$up_doc_name."','".$display."','".$m_doc_type."')";
		//echo $sqlInsert; exit;
		if (CDBCon::GetInstance()->Execute($sqlInsert) === false) 
			{ 
				return false;
