...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    ...
    <td width="38%"><div id="content"><table width="94%" border="0" align="center" cellpadding="2" cellspacing="2">
            <tr>
              <td width="82"><div align="center"><a href="signindefault.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','images/frontpage2.png',1)"><img src="images/frontpage.png" alt="Home" name="Image4" width="48" height="48" border="0" id="Image4" /></a><a href="signindefault.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image4','','images/frontpage2.png',1)"></a><a href="select.php" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('Image3','','images/frontpage2.png',1)"><br />
              ...
              <td width="62"><div align="center"><a href="about_us.php"><img src="images/langmanager.png" width="48" height="48" /></a><br />
              About Us</div></td>
              ...
              <td width="77"><div align="center"><img src="images/addedit.png" width="41" height="34" /><br />
                  Add Abou Us</div></td>
            </tr>
          </table>
    </div></td>
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td bgcolor="#F1F3F5" class="adminlist"><div align="left"><strong>Add About Us Details</strong></div></td>
        </tr>
        <tr>
          <td bgcolor="#F1F3F5"><form action="controlers/aboutuscontroler.php?mode=add_aboutus" method="post" enctype="multipart/form-data" name="form1" id="form1">
