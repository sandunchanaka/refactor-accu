...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="content"><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#CCCCCC">
        <tr>
          <td valign="middle" bgcolor="#F1F3F5" class="adminlist"><div align="center"><strong>New Member Profile --&gt;&gt; Contact Contact person</strong></div></td>
        </tr>
        <tr>
          <td bgcolor="#F1F3F5"><form name="form1" id="form1" method="post" enctype="multipart/form-data" action="controlers/membercontroler.php?mode=add_contactperson&member_id=<?php echo $member_id;?>">
            ...
            <table width="90%"  border="0" align="center" cellpadding="2" cellspacing="2" class="cls_border">
              ...
              <tr>
                ...
                <td>Fax</td>
                <td>:</td>
                <td><input name="txt_Postal_fax" type="text" id="txt_Postal_fax" size="25" /></td>
              </tr>
              <tr>
                <td>&nbsp;</td>
                <td>E mail</td>
              ...
              <tr>
                ...
                <!--	<input name="btn_cancel" type="button" class="button" value="Cancel" onclick="window.location.href='new_member_basic_details.php'" id="btn_cancel" />  -->               <input name="btn_cancel" type="button" class="button" value="   Next   " onclick="window.location.href='new_regulater.php?member_id=<?php echo $member_id; ?>'" id="btn_cancel" /></td>
              </tr>
              <?php }?>
            </table>
          </form></td>
