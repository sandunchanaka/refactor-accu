...
<body>
<!-- CSS 
<link rel="stylesheet" href="light box/css/default.css" media="screen,projection" type="text/css" />
<link rel="stylesheet" href="light box/css/lightbox.css" media="screen,projection" type="text/css" />

 JavaScript 
<script type="text/javascript" src="light box/scripts/prototype.js"></script>
<script type="text/javascript" src="light box/scripts/lightbox.js"></script>-->
...
<li class="breadcrumb">
    <ul>
        <li><a href="index.php">Home</a></li>
                ...
                <li class="current" ><a href="#">CU Solutions</a></li>
...
<?php include("tpl/logged_user.tpl");?>
</li>
...
We are very pleased that our members have made a tremendous move to build upon these solutions.</p>
         ...
         <span style="color:#F30; font-size:12px;">Incorrect User name or Password</span>
         <?php }?>
    ...
    {
        position:absolute; top:0; left:0;width:157px; overflow:hidden; border:5px solid #fff;
    }
...
<li class="odd">
	<dl>
        ...
        <dd class="product-name"><a href="<?php echo $row["value"]["link"]; ?>" target="_blank" title=""><?php echo $row["value"]["solution_name"]; ?>
        <div>
        ...
        <dd class="txt">
         ...
         <?php 
					 ...
					 ?>
        <dd class="downloads"><a <?php if($docrow['value']['file_name'] !=''){ ?> href="download-cu-solutions.php?path_id=4&publication_name=<?php echo $docrow['value']['file_data']; }?>" class="lbOn"><?php echo $docrow['value']['file_name']; ?> </a> </dd>
        <?php } // Upload Files
		if($i==1){ ?>
