...
require_once('common/accu_online_forum.class.php');
?>
<body>
...
<li class="breadcrumb">
    <ul>
        <li><a href="index.php">Home</a></li>
                ...
                <li class="current" ><a href="#">AACCU Forum</a></li>
...
<h1>Welcome to the ACCU Internet Forum!</h1>

<p>ACCU Internet forum is an online discussion site. The forum is full of real people talking about real issues. This is a great place to find people who are interested in the same credit union issues as you are. The ACCU Internet Forum in general does two basic things: it gives you a place to learn more about the four major issues in credit union you are interested in, and they give you a place to help others who have questions that you know the answers to. Topics for discussion evolve around main issues of concern on the development of credit unions. These topics include the following:</p>
