...
require_once (DOC_ROOT.'classes/db.class.php');
...
if($_POST['page']) {
	...
	$msg .= '<h2 class="home"><a href="#">ACCU Events</a><a href="#" class="icons feed-icon">News RSS Feed</a></h2>';
		$msg .= '<div class="news-listing meta-dynamic-content-container" style="height: 403px;">';
			$msg .= '<ul class="listing absolute" style="height: 403px;">';
				...
				while ($row = mysql_fetch_array($result_pag_data)) {
					...
					$msg .= '<li class="news news-with-image first" style="width: 350px; display: list-item;">';
						...
						$msg .= '</div>';
						$msg .= '<div class="details"><span class="date" title="17/12/2012">'.$row['event_starting_date'].'</span>';
						$msg .= '<h4><a href="#" title="'.$row['event_name'].'">'.nl2br($row['event_name']).'</a></h4>';
						$msg .= '<p class="excerpt"><span class="meta-info">';
						$msg .= '<a href="#" class="read-more">read more</a></span></p>';
						$msg .= '</div>';
