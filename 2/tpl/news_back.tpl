...
<div class="news-listing meta-dynamic-content-container" style="height: 403px;">
	<ul class="listing absolute" style="height: 403px;">
    	...
    	<li class="news news-with-image first" style="width: 350px; display: list-item;">
        	...
        	<div class="details"><span class="date" title="17/12/2012"><?php echo $row_n["value"]['news_date']; ?> <!--////Monday December 17, 2012--></span>
        	<h4><a href="#" title="<?php $row_n["value"]['news_name']; ?>"><?=nl2br($row_n["value"]['news_name'])?></a></h4>
        	<p class="excerpt"><span class="meta-info">
        	<a href="#" class="read-more">read more…</a></span></p>
            </div>
    ...
    <ul class="pager">
        ...
        <li class="meta-all-items"><a href="#" title="View all news items">View All</a></li>
	</ul> <!-- .pager -->
</div>
<hr />