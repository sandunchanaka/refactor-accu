...
<ul class="primary-navigation">
    ...
    <li class="first"><a href="publications.php" class=""><span class="toi">PUBLICATION</span></a>
        <ul class="level-two">
         <li class=" "><a href="publications.php" class="second-level">PUBLICATION</a></li>
        <?php 
            $pt =0;
        ...
        ?>
        <li class=" "><a href="publication-documents.php?pub_cat_id=<?php echo $pub_type1['value']['publication_cat_id']; ?>&cat_name=<?php echo $pub_type1['value']['pub_cat_name']; ?>" class="second-level"><?php echo $pub_type1['value']['pub_cat_name']; ?></a></li>
        <?php } ?>
        
        </ul>
	</li>
        <li class="first"><a href="member-category.php" class=""><span class="toi">MEMBERS</span></a>
        <ul class="level-two">
        <li class=" "><a href="member-category.php" class="second-level">MEMBERS</a></li>
        <?php 
            $m = 0;
        ...
        ?>
        <li class=" "><a href="members.php?mem_type_id=<?php echo $member_row["value"]["member_type_id"];?>&amp;mem_type=<?php echo $member_row["value"]["member_type_name"]; ?>" class="second-level"><?php echo $member_row['value']['member_type_name'];?></a></li>
        <?php } ?>
        </ul>
	</li>
    <li class="first"><a href="cu-solutions.php" class=""><span class="toi">CU SOLUTIONS</span></a>
        <ul class="level-two">
        <?php 
		  $c = 0;
...
<li class="first"><a href="#" class="" target="_blank"><span class="toi">FORUM</span></a>
	</li>
...
//<![CDATA[
    $(document).ready(function () {
        ...
        if (href.indexOf('Portal/default.aspx.htm') > 0) {
            var item = $('#main-menu ul li a[href*="Portal/home.aspx.htm"]');
