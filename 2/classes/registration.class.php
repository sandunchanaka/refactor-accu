<?php
	class Registration
	{
		...
		function updateresavation_type($m_reg_id,$m_room_type,$m_chk_in_date,$m_chk_out_date)
		{
				$sqlInsert = "UPDATE event_registration SET room_type='".$m_room_type."',chk_in_date='".$m_chk_in_date."',chk_out_date='".$m_chk_out_date."' WHERE reg_id='".$m_reg_id."'";
				//echo $sqlInsert; exit;
