...
<div id="photo-gallery" class="listing photo-gallery">
    <ul class="general-listing">
        <li class="photo gv ">
            <a href="" class="image-frame"><img src="../Content/siteimages/AAA_6245.jpg"  alt="Summit Day 1" /></a>
            <div class="item-details">
            <span>Photos: 21</span>
            </div>
            <h4><a href="">Seminar Day 1 - Opening Session</a></h4>
        <li class="photo gv ">
            <a href="" class="image-frame"><img src="../Content/siteimages/DSC_7424.jpg" alt="Opening Ceremony" /></a>
            <div class="item-details"><span>Photos: 13</span></div>
            <h4><a href="">Seminar Day 1 - Second Session</a></h4>
        <li class="photo gv ">
            <a href="" class="image-frame"><img src="../Content/siteimages/DSC_0132.jpg" alt="Zayed Future Energy Prize" /></a>
            <div class="item-details">
            <span>Photos: 14</span>
            </div>
            <h4><a href="">Seminar Day 1 - Third Session</a></h4>
        <li class="photo gv last"><a href="" class="image-frame"><img src="../Content/siteimages/DSC_0223.jpg" alt="Summit Day 2" /></a>
            <div class="item-details">        
            <span>Photos: 165</span></div>
            <h4><a href="">Seminar Day 2 - First Session</a></h4>
       <li class="photo gv "><a href="" class="image-frame"><img src="../Content/siteimages/DSC_7272.jpg" alt="Summit Day 3" /></a>
       <div class="item-details">
       <span>Photos: 16</span>
       </div>
       <h4><a href="">Summit Day 2 - Second Session</a></h4>
       <li class="photo gv "><a href=""  class="image-frame"><img src="../Content/siteimages/DSC_7190.jpg"></a>
       <div class="item-details">
       <span>Photos: 16</span>
       </div>
       <h4><a href="">Summit Day 2 - Third Session</a></h4>
