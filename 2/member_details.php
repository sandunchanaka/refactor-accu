              ...
              <td valign="top"><table width="100%" align="center" cellpadding="0" cellspacing="0">
               ...
               <?php if ($row["value"]["fax_no"] != ''){ ?>
                ...
                <tr style="background-color: #{cycle values = 'CCD9FF, A6BCFF'}">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="6%" class="login_text">&nbsp;</td>
                      <td width="91%" height="25" class="news_index">Contact Person:</td>
                      <td width="3%">&nbsp;</td>
                    </tr>
                    <?php
					$i=0;
                ...
                <tr style="background-color: #{cycle values = 'CCD9FF, A6BCFF'}">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td width="6%" class="login_text">&nbsp;</td>
                      <td width="91%" class="news_index">Regulator: </td>
                      <td width="3%">&nbsp;</td>
                    </tr>
                    <?php
					$j=0;
                ...
                <tr style="background-color: #{cycle values = 'CCD9FF, A6BCFF'}">
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="5%" class="login_text">&nbsp;</td>
                        <td width="87%" class="news_index">Board of Directors:</td>
                        <td width="8%">&nbsp;</td>
                      </tr>
                      <?php
					$k=0;
