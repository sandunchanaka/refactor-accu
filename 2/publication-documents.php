		  ...
		  <div id="content" class="print-area">
		    <div id="content2" class="print-area">
		      ...
		      <div class="content-container"> <span class="clearfix"></span>
				...
				$i=1;
		   ?>
                  <h2 class="section-header"><span><?php echo $row["value"]["document_name"]; ?></span></h2>
		          ...
		          <table class="general-table" cellspacing="0" cellpadding="0">
		            <tbody>
                      ...
                      <?php
									  ...
									  ?>
		              <tr>
		                <td><?php echo $row1['value']['pub_doc_name'];?></td>
		                <td><a class="file-type-pdf" href="form01.php">View</a></td>
		                <td><a <?php if($row1['value']['pub_doc_file'] !=''){ ?> href="download.php?path_id=1&publication_name=<?php echo $row1['value']['pub_doc_file']; }?>" class="general-download-link" >Download</a></td>
	                  </tr>
					<?php } ?>
	                </tbody>
	              </table>
