...
<!--/MOD_25a1441f-8ac1-4d7e-be18-bf68bf52572d-->
	...
	<div id="main">		<div class="container">
		  <div id="content" class="print-area">
			...
			$row = each($membertype);			
			  ?>
                  <h2 class="section-header"><span><a href="members.php?mem_type_id=<?php echo $row["value"]["member_type_id"];?>&amp;mem_type=<?php echo $row["value"]["member_type_name"]; ?>"><?php echo $row["value"]["member_type_name"]; ?></a></span>
                  <a href="pub_documents.php?pub_cat_id=<?Php echo $row["value"]["publication_cat_id"]; ?>&amp;cat_name=<?php echo $row["value"]["pub_cat_name"]; ?>" class="linkTest">
