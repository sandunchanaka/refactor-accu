...
<!-- <a href="wfes-privilege-club-2013.aspx"  style="margin-bottom:10px; display:block; width:221px;
height:80px;" target="_self">
<img src="content/images/privilege-club-banner.gif" alt="ADSW" />
</a> -->
<!--
<a href="technology-exchange-platform.aspx"  style="margin-bottom:10px; display:block; width:221px;
height:80px;" target="_self">
<img src="content/images/txp-banner2.jpg" alt="TXP" />
</a> -->
...
<div class="logo-box-slider social-media-img-type2">
						...
						<span class="corner lg-gbr"></span>
                                                 <a href="https://www.facebook.com/accu.thailand?fref=ts" target="_blank" style="margin-right:10px;"><img src="content/images/fb-30x30.jpg" width="30" height="30" alt="facebook"></a>
