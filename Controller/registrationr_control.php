<?php
	...
	switch ($mode)
	{
		...
		case 'reg_05':
			...
			$room_type				='';
			$room_type_single		=	isset( $_POST['rdo_room_type'])?$_POST['rdo_room_type']:0;
			$room_type_smoking		=	isset( $_POST['rdo_room_type2'])?$_POST['rdo_room_type2']:0;
			...
			{
				$regResult = Registration :: updateresavation_type($reg_id,$room_type_single,$room_type_smoking,$chk_in_date,$chk_out_date);
