...
<li class="breadcrumb">
    <ul> 
        ...
        Registration </a></li>
                <li class="separator">\</li>
                <li class="" ><a href="#">Travel Information - Arrival</a></li>
	...
	<div id="main">		<div class="container">
	  <div id="content" class="print-area">
	    ...
	    <div class="content-container"> <span class="clearfix"></span>
	      <h1>Travel Information - Arrival</h1>
	      <p></p>
	      ...
	      <div class="section-body">
           <form action="Controller/registrationr_control.php?mode=reg_06" method="post" name="form5">
<table width="100%" border="0">
              ...
              <td><table width="100%" border="0">
                <tr>
                  ...
                  <td width="63%"><span id="sprytextfield1">
                    <label>
                      <input name="txt_airline" type="text" class="r_texbox" id="txt_airline" size="40" value="<?php echo $get_data['a_airline']; ?>">
                ...
                <tr>
                  ...
                  <td><span id="sprytextfield2">
                    <label>
                      <input name="txt_flight_no" type="text" class="r_texbox" id="txt_flight_no" value="<?php echo $get_data['a_flight_no']; ?>">
                    <span class="textfieldRequiredMsg">*</span>                    </label>
                  </span></td>
                </tr>
                <tr>
                  <td class="eventreg_text">Arrival City </td>
                  <td>:</td>
                  <td><span id="sprytextfield3">
                    <label>
                      <input name="txt_arrival_city" type="text" class="r_texbox" id="txt_arrival_city" value="<?php echo $get_data['a_city']; ?>">
                    <span class="textfieldRequiredMsg">*</span>                    </label>
                  </span></td>
                </tr>
                <tr>
                  <td class="eventreg_text">Arrival Airport </td>
                  <td>:</td>
                  <td><span id="sprytextfield4">
                    <label>
                      <input name="txt_arrival_airport" type="text" class="r_texbox" id="txt_arrival_airport" value="<?php echo $get_data['a_airport']; ?>">
                    <span class="textfieldRequiredMsg">*</span>                    </label>
                  </span></td>
                </tr>
                <tr>
                  ...
                  <td><span id="sprytextfield5">
                    <label>
                      <input name="txt_date_time" type="text" class="r_texbox" id="txt_date_time" value="<?php echo $get_data['a_date_and_time']; ?>">
                    <span class="textfieldRequiredMsg">*</span>                    </label>
                  </span></td>
                </tr>
                <tr>
            ...
            <tr>
              ...
              <td><table width="100%" border="0">
                <tr>
                  <td width="53%">&nbsp;</td>
                  <td width="10%"><input type="button" name="btn_back" id="btn_back" value="  &lt;&lt; Back    " onClick="window.location.href='registration_form_05.php?reg_id=<?php echo $reg_id; ?>'"></td>
