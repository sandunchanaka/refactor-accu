...
define('DB_DB','aaccu_coop');
//define('DB_DB','accucoop');
define('DB_TYPE','mysql');

/*define doc root */
//define('DOC_ROOT', 'G:/Program Files/Apache Software Foundation/Apache2.2/htdocs/Accu_hosting/');
//define('HTTP_ROOT', 'http://localhost/Accu_hosting/');
