...
<span class="clear"></span>
<h1>CU Solutions - Member Login</h1>
<p>
...
<!--<h2 class="section-header"><span>Log in to Member - Zone</span></h2>-->
   <form name="memberlogin" id="memberlogin" action="Controller/user_control.php?mode=culogin" method="post" enctype="multipart/form-data">
    <input name="hdn_page" class="loginBoxes" id="hdn_page" type="hidden" value="<?php echo $_SERVER['PHP_SELF'];?>" />
    <input name="hdn_document" class="loginBoxes" id="hdn_document" type="hidden" value="<?php echo $_GET["pub_name"]; ?>" />
