...
<form id="form1" name="form1" method="post" action="access_control/access_register_control.php?mode=reg">
  <table width="94%" height="794" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td colspan="5" align="left" bgcolor="#C9C9C9" class="big">&nbsp;</td>
    </tr>
    <tr>
      <td width="11%" height="15" align="center" valign="bottom" bgcolor="#DDDDDD">&nbsp;</td>
      <td colspan="3" align="center" valign="bottom" bgcolor="#DDDDDD"><img src="access_image/que_head.gif" width="100%" height="15" /></td>
    ...
    <tr>
      ...
      <td height="43" align="center" bgcolor="#FFFFFF"><p class="IntroText_new">ACCU Web Based Access Application</p>
        ...
        <table width="102%" height="343" border="0" cellpadding="0" cellspacing="2">
          ...
          <tr>
            <td colspan="2" valign="top" class="About_US_link">Country Name</td>
          ...
          <tr>
            <td colspan="2" valign="top" class="About_US_link">District</td>
            <td width="14" valign="top">&nbsp;</td>
          ...
          <tr>
            <td colspan="2" valign="top" class="About_US_link">Name of Credit  Cooperatives and societies  Union</td>
            <td width="14" valign="top">&nbsp;</td>
          ...
          <tr>
            <td width="75" valign="top" class="About_US_link">Address </td>
            <td width="102" valign="top" class="About_US_link"><table width="69" height="81" border="0">
                <tr>
                  <td width="96" height="23">&nbsp;</td>
                </tr>
                <tr>
                  <td><span class="About_US_link">City</span></td>
                </tr>
                <tr>
                  <td><span class="About_US_link">Country</span></td>
                </tr>
            </table></td>
            <td width="14" valign="top">&nbsp;</td>
          ...
          <tr>
            <td colspan="2" valign="top" class="About_US_link">Register Number</td>
            <td valign="top">&nbsp;</td>
          ...
          <tr>
            <td colspan="2" valign="top" class="About_US_link">Phone Number</td>
            <td width="14" valign="top">&nbsp;</td>
          ...
          <tr>
            <td colspan="2" valign="top" class="About_US_link">Fax</td>
            <td width="14" valign="top">&nbsp;</td>
          ...
          <tr>
            <td height="24" colspan="2" valign="top" class="About_US_link">E Mail Address</td>
            <td width="14" valign="top">&nbsp;</td>
          ...
          <tr>
            <td height="22" colspan="2" valign="top" class="About_US_link">Pass word</td>
            <td width="14" valign="top">&nbsp;</td>
            <td valign="top">
          ...
          <tr>
            <td height="22" colspan="2" valign="top" class="About_US_link">Re type Pass Word</td>
            <td width="14" valign="top">&nbsp;</td>
            <td valign="top">
    ...
    <tr>
      <td width="11%" height="19" align="center" bgcolor="#DDDDDD">&nbsp;</td>
  ...
  <table width="100%" height="339" border="0" cellpadding="0" cellspacing="2">
    ...
    <tr>
      <td colspan="2" valign="top" class="About_US_link">Operational Area</td>
    ...
    <tr>
      <td width="137" valign="top" class="About_US_link">Number Of Employee</td>
      <td width="52" valign="top" class="About_US_link"><table width="47" border="0">
          <tr>
            <td width="41" height="23"><span class="About_US_link">Male</span></td>
          </tr>
          <tr>
            <td><span class="About_US_link">Female</span></td>
          </tr>
      </table></td>
      <td valign="top">&nbsp;</td>
    ...
    <tr>
      <td colspan="2" valign="top" class="About_US_link">Established In (Year)</td>
      <td valign="top">&nbsp;</td>
    ...
    <tr>
      <td colspan="2" valign="top" class="About_US_link">Type Of Services</td>
      <td valign="top">&nbsp;</td>
    ...
    <tr>
      <td colspan="2" valign="top" class="About_US_link">Total Share Amount (in US $)</td>
      <td valign="top">&nbsp;</td>
    ...
    <tr>
      <td colspan="2" valign="top" class="About_US_link">Deposit</td>
      <td valign="top">&nbsp;</td>
    ...
    <tr>
      <td colspan="2" valign="top" class="About_US_link">Savings</td>
      <td valign="top">&nbsp;</td>
    ...
    <tr>
      <td colspan="2" valign="top" class="About_US_link">Loan Outstanding(less than US $300)</td>
      <td valign="top">&nbsp;</td>
    ...
    <tr>
      <td colspan="2" valign="top" class="About_US_link">Total Reserve</td>
      <td valign="top">&nbsp;</td>
    ...
    <tr>
      <td colspan="2" valign="top" class="About_US_link">Total Assest</td>
      <td valign="top">&nbsp;</td>
    ...
    <tr>
      <td height="30" colspan="4" align="center"><table width="200" border="0">
          <tr>
            ...
            <td width="76" align="center"><label>
              <input type="button" name="button_cancel" id="button_cancel" value="Cancel" onClick="window.location.href='access_branding.php'" />
            </label></td>
          </tr>
      </table></td>
    </tr>
      ...
      <td width="13%" height="19" align="center" bgcolor="#DDDDDD">&nbsp;</td>
    </tr>
    <tr>
      <td height="19" align="center" valign="top" bgcolor="#DDDDDD">&nbsp;</td>
      <td height="19" colspan="3" align="center" valign="top" bgcolor="#DDDDDD"><img src="access_image/que_fot.gif" alt="" width="145%" height="15" /></td>
      <td height="19" align="center" valign="top" bgcolor="#DDDDDD">&nbsp;</td>
    </tr>
    <tr>
      <td colspan="5" bgcolor="#DDDDDD">&nbsp;</td>
    </tr>
  </table>
</form>
