...
<h3>Current Career Positions</h3>

<p><strong>Project Officer<br />
   Manager Technical services<br />
External advisor organizational strengthening, based in Luang Prabang (LaoPDR)<br /></strong></p>
 <ul>
  <li>JOIN a diverse staff with diverse accountabilities...</li>
  <li> IMPLEMENT cutting edge tools and technologies...</li>
  <li>PARTICIPATE in a dynamic work environment...</li>
  <li>RECEIVE comprehensive benefits and services...</li>
 </ul>
  <h3>Employer Paid...</h3>
 <ul>
  <li> sick leave and holidays</li>
  <li>Pension plan</li>
  <li> Retirement plan</li>
  <li> Standard and optional life insurance</li>
  <li> Long-term disability</li>
  <li>Accidental death and dismemberment</li>
  <li>Travel-related corporate insurance</li>
 </ul>
  ...
  <li>International safety/security training</li>
  <li> Informative new hire orientations</li>
  <li>International project summaries</li>
  <li> Travel highlights</li>
  <li> Bi-weekly staff presentations</li>
...
<h3>Job-Specific Opportunities</h3>
<ul>
  <li> Assignments in Abroad</li>
  <li> International travel</li>
  <li>Leadership and initiatives</li>
 </ul>
  <p style="font-weight:bold;"> Expect the best! Please send resumes for the above positions to Human Resources, ceo@aaccu.coop</p><br>
<br><br>
<br><br>
<br>
  <p>&nbsp;</p><br>
