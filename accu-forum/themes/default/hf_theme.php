...
// ]]></script>
	...
	<tr>
		...
		<a href="http://www.aaccu.asia/"><img src="'.(!empty($theme['headerimg']) ? $theme['headerimg'] : $theme['images'].'accu_logo.jpg').'" alt="" /></a>
		</td>
...
// ]]></script>';
	...
	//Back to main  site
	$opt[] = '<a href="http://www.aaccu.asia/" act=calendar">Home</a>';
