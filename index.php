...
<div class="widget banner-zone" style="display:none">
        ...
        <div id="secondary">
        <!------------------- ACCU DOnations ------------------------------->
        <h2 style="font-size:14px; font-weight:bold;">Donation for ASIA FUND FOR CREDIT UNION DEVELOPMENT (AFCUD)</h2>
<div class="logo-box-slider" id="logo-listing-principal" style="width:360px; height:135px; margin-bottom:5px; padding:0;">
						
                        <?php include("tpl/donation_slide_show.tpl");?>
						
					</div>
<!-- ACCU DONATIONS-------------------------------------------------><br>
<h2>ASIAN CREDIT UNION FORUM</h2>
		<div style="width:360px; height:120px; margin-bottom:5px;">        
        <img src="content/images/open_forum.jpg" alt="ACCU OPEN FORUM 2013" width="360" height="117" border="0" usemap="#Map2" style="margin-bottom:5px;">
          <map name="Map2">
