...
<li class="breadcrumb">
    <ul>
        <li><a href="index.php">Home</a></li>
                ...
                <li class="separator">\</li>
                <li class="current" ><a href="#">Events Highlights</a></li>
		  ...
		  <div id="content" class="print-area">
		    ...
		    <div class="content-container"> <span class="clearfix"></span>
		      ...
		      <div class="general-vertical-listing listing" id="newsListing">
                ...
                <?php
				$query = "SELECT * FROM event ORDER BY event_starting_date DESC";
				$numrows = Events::Get_More_Events($query);
				...
				$results = Events::Get_More_Events($query);
				
				for($n = 0;$n<count($results);$n++){
				$getrow = each($results);	
				?>
		         <!-- <li><a href="#" title="" class="image-frame-1-small"><img src="../Content/Generated/Thumbnails/eadb8880_8c1x5c1wffffff.jpg" alt="" /></a>-->
		            <h4><a href="event.php?event_id=<?php echo $getrow["value"]['event_id'];?>" title="<?php echo $getrow["value"]["event_name"]; ?>"><?php echo $getrow["value"]["event_name"]; ?></a></h4>
                    <div class="inner"><span class="date" title="<?php echo $getrow["value"]['event_starting_date']; ?>">Event Starting Date :		
					<?php  
			$getdate = strtotime($getrow["value"]['event_starting_date']);
			echo date("l F d, Y", $getdate); ?></span>
            <span class="date" style="float:right;" title="<?php echo $getrow["value"]['event_end_date']; ?>">Ending Date  :		
					<?php  
			$getdate = strtotime($getrow["value"]['event_end_date']);
			echo date("l F d, Y", $getdate); ?></span>
                       ...
                       &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <a href="event.php?event_id=<?php echo $getrow["value"]['event_id'];?>" class="read-more">read more…</a></span></p>
	                </div>
